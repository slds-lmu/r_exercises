...
show.next <- FALSE
tutorial_options(exercise.checker = checker_endpoint, exercise.reveal_solution = FALSE)
...
```{r data, exercise=TRUE, exercise.setup = "task-solution"}
...
```{r data-solution, exercise.setup = "task-solution"}
...
```{r learner, exercise=TRUE, exercise.setup = "data-solution"}
...
```{r learner-solution, exercise.setup = "data-solution"}
...
```{r train-solution, exercise.setup = "learner-solution"}
...
```{r predict, exercise=TRUE, exercise.setup = "train-solution"}
...
```{r predict-solution, exercise.setup = "train-solution"}
...
```{r pe, exercise=TRUE, exercise.setup = "predict-solution"}
"your code"
```
